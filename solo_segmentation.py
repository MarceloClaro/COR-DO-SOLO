...
Faça o upload de uma imagem do solo que você deseja analisar.
Selecione o método de clusterização que você deseja usar (K-Means ou Fuzzy C-Means).
Selecione o número de clusters que você deseja usar na análise.
Clique no botão 'Classificar cores' para iniciar a análise.
O aplicativo exibirá a imagem segmentada, a classificação do solo, gráficos e informações adicionais sobre a margem de erro e desvio padrão.
Explore os resultados e ajuste as configurações conforme necessário para obter os melhores resultados.
""")
...
Munsell Soil Color Charts. [https://www.munsell.com/color-services/color-standards/soil-color-charts/]
Embrapa. Sistema Brasileiro de Classificação de Solos. [https://www.embrapa.br/solos/sistema-brasileiro-de-classificacao-de-solos]
