...
#MATRICULA - 20181124040073
#https://orcid.org/0000-0001-8996-2887
#http://lattes.cnpq.br/8352973381075607
#Diretório de Instituições - DI : Projeto Antenado
#Sigla da instituição: ANTENADO
#CNPJ:	11.649.236/0001-70
#Razão social:	Marcelo Claro Laranjeira
#Código no CI:	JR9F00000001
#http://di.cnpq.br/di/cadi/infoInstituicao.do?acao=buscaDadosInst&nroIdInst=737005
# ESTUDOS GEOTECNOLOGIA PARA O DESENVOLVIMENTO DE MATERIAIS DIDÁTICOS
#ORIENTADORA FLÁVIA INGRID - VIRGINIA 
#PROJETO - VISÃO COMPUTACIONAL APLICADO NO SISTEMA DE CORES DE MUNSELL PARA SOLO. 
...
# declarar variáveis ​​globais (são usadas mais tarde)
clicked = False
r = g = b = xpos = ypos = 0
